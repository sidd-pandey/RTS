import sys
sys.path.insert(0, "/home/siddharth/GitHub/SO-Net")
import argparse
import os
...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/home/siddharth/modelnet40-normal_numpy', help='path to images & laser point clouds')
